...
const Steps = () => {
  return (
    ...
    viewport={{once: true}}
    >
      <h1 className='text-3xl sm:text-4xl font-semibold mb-2'>Know the Full Process</h1>
      <p className='text-lg mb-8 text-gray-600'>Transform text in Stunning Images</p>
